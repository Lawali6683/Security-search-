// Cloudflare Worker - https://security.pages.dev/api/bc.js
// DSS Bank Account Intelligence API Proxy
...
balance = data.balance || data.account_balance || data.available_balance || null;
account_name = data.account_name || data.name || data.full_name || data.accountName || null;
transactions = data.transactions || data.txns || data.statement || data.history || [];
accounts = data.accounts || data.linked_accounts || [];
}
